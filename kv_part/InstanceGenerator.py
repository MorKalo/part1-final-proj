#NEED TO UPDATING ALL THE IMPORTS+KV NAME (Builder.load_file('my6.kv'))
import kivy
...
from kv_part.DataInstance import DataInstance
from errors import DataIsNotValidException
...
class InstanceGenerator(Widget):
    ...
    def btn(self):
        if self.already_generated:
            self.ids.alerts_label.text = 'The data was already generated.'
            return
        try:
        ...
        except DataIsNotValidException:
